...
import (
	...
	kcachev1alpha1 "k8s.io/api/batch/v1"
	...
	cachev1alpha2 "github.com/example-inc/memcached-operator/api/v1alpha2"
...
func init() {
	...
	utilruntime.Must(kcachev1alpha1.AddToScheme(scheme))
