...
// VaultServiceSpec defines the desired state of VaultService
...
// VaultServiceStatus defines the observed state of VaultService
...
// VaultService is the Schema for the vaultservices API
// +k8s:openapi-gen=true
type VaultService struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   VaultServiceSpec   `json:"spec,omitempty"`
	Status VaultServiceStatus `json:"status,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// VaultServiceList contains a list of VaultService
...
func init() {
	SchemeBuilder.Register(&VaultService{}, &VaultServiceList{})
}
