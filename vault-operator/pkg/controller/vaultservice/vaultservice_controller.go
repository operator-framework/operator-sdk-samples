...
var log = logf.Log.WithName("controller_vaultservice")
...
// Add creates a new VaultService Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileVaultService{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("vaultservice-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}
...
var _ reconcile.Reconciler = &ReconcileVaultService{}

// ReconcileVaultService reconciles a VaultService object
type ReconcileVaultService struct {
...
// Reconcile reads that state of the cluster for a VaultService object and makes changes based on the state read
// and what is in the VaultService.Spec
// TODO(user): Modify this Reconcile function to implement your Controller logic.  This example creates
// a Pod as an example
// Note:
// The Controller will requeue the Request to be processed again if the returned error is non-nil or
// Result.Requeue is true, otherwise upon completion it will remove the work from the queue.
func (r *ReconcileVaultService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
...
func newPodForCR(cr *vaultv1alpha1.VaultService) *corev1.Pod {
